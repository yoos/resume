...
% TODO: This is a hack to make my contact info look a bit more organized.
 \vspace{-1.2em}
 \moveleft.5\hoffset\centerline{yoos@onid.oregonstate.edu \hfill iterativecode.com}
...
{\it Computer Science (3.26/4.0 GPA, graduation June 2015)} \hfill {\color{lightgray} Sep. 2011 -- Present}\vspace{0.2em}
...
\begin{itemize}
	...
	\item Basic: \hspace{17pt} JavaScript, DelphiScript, CoffeeScript, HTML,
		CSS, PHP
\end{itemize}
...
\begin{itemize}
	...
	\item Proficient: ChibiOS embedded RTOS, Robot Operating System, Open Robot
		Control System
	\item Basic: \hspace{17pt} OpenCV, ZeroMQ, AngularJS, Qt, GTK+, Vagrant,
...
\begin{itemize}
	...
	% \item Prototyped an automation script and GUI in Altium to improve
	% 	efficiency when derating designs.
\end{itemize}
