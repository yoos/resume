...
\begin{itemize}
	...
	\item Proficient: ChibiOS embedded RTOS, Robot Operating System, Open Robot
		Control System
	\item Basic: \hspace{17pt} Qt, GTK+, Vagrant, Subversion, Mercurial
\end{itemize}
...
%		future integration into flight systems. Designed PCI-Express testboard
%		and conducted radiation tests of four other evaluation boards at IU
...
%		hardware test racks.
	\item Designed testboards to:
		\begin{itemize}
			...
			\item Compare efficiency of several switching regulators
...
\begin{itemize}
	\item Developed and integrated administrative course installation Python
		backend into existing web framework and user frontend interface in
		Drupal. Made small bugfixes in various other projects.
\end{itemize}
...
\begin{itemize}
	\item Assembled software system using ROS and Orocos for ATRIAS, an
		EtherCAT-enabled bipedal robot. System capable of running modular, hard
...
\begin{itemize}
	\item Developed embedded flight control firmware using direction cosine
		...
		software. Team Lead Sep. 2012 -- Oct. 2013.
\end{itemize}
