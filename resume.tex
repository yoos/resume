...
{\it Computer Science (3.25/4.0 GPA, graduation June 2015)} \hfill {\color{lightgray} Sep. 2011 -- Present}\vspace{0.2em}
...
{\bf Software Languages}\vspace{0.2em}

\begin{itemize}
	\item Proficient: C, C++, Python, Bash, \LaTeX
	\item Basic: \hspace{17pt} JavaScript, DelphiScript, CoffeeScript, HTML, CSS, PHP
\end{itemize}
...
\begin{itemize}
	...
	\item Proficient: ChibiOS embedded RTOS, Robot Operating System, Open Robot
		Control System
	\item Basic: \hspace{17pt} OpenCV, ZeroMQ, AngularJS, Qt, GTK+, Vagrant, Subversion, Mercurial
\end{itemize}
